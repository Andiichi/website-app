                ...
                <div class="bg-white rounded-md px-4 py-6 h-max shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
                    <ul class="text-gray-800 space-y-4">
                        <li class="flex flex-wrap gap-2 text-sm font-medium">
                            Subtotal<span class="text-[0.6rem] ml-auto mt-1">R$</span><span class="text-xl">206.00</span></h3>
                        </li>
                        <li class="flex flex-wrap gap-2 text-sm font-medium">
                            Tx. Tributos<span class="text-[0.6rem] ml-auto mt-1">R$</span><span class="text-xl">206.00</span></h3>
                        </li>
                        <li class="flex flex-wrap gap-2 text-sm font-medium">
                        ...
                        <li class="flex flex-wrap gap-2 text-xl font-bold">
                            Total<span class="text-[0.6rem] ml-auto mt-1">R$</span><span class="text-xl">
                                {{ $total = Cart::total(2, ',', '.') }}
