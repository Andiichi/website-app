    ...
    <x-site.alert />
        ...
        @else
            <div class="font-sans max-w-5xl max-md:max-w-xl mx-auto p-4">
                <h2 class="text-2xl font-semibold text-gray-800 mb-12">Seu carrinho possui
                        ...
                        @foreach ($itens as $item)
                            <div
                                            ...
                                            <form action="{{ route('site.atualizarcarrinho', $item->rowId) }}"
                                                ...
                                                <div class="relative flex items-center item-row">
                                                    ...
                                                    <input type="text" id="counter-input"
                                                        ...
                                                        placeholder="" name="qty" data-csrf='{{ csrf_token() }}'
                                ...
                                <div class="ml-auto flex flex-col">
                                    ...
                                    <h3 class="font-bold text-gray-800 mt-auto"><span
                                            class="text-[0.6rem] pr-1">R$</span><span
                    ...
                    <div class="bg-white rounded-md px-4 py-6 h-max shadow-[0_2px_12px_-3px_rgba(6,81,237,0.3)]">
                        <ul class="text-gray-800 space-y-4">
                            <li class="flex flex-wrap gap-2 text-sm font-medium">
                                Subtotal<span class="text-[0.6rem] ml-auto mt-1">R$</span><span id='subtotalcarrinho'
                                    class="text-xl">{{ $subtotal = \Cart::subtotal(2, ',', '.') }}</span>
                                </h3>
                            </li>
                            <li class="flex flex-wrap gap-2 text-sm font-medium">
                                Tx. Tributos<span class="text-[0.6rem] ml-auto mt-1">R$</span><span id='taxcarrinho'
                                    class="text-xl">0.0</span></h3>
                            </li>
                            <li class="flex flex-wrap gap-2 text-sm font-medium">
                                Frete<span class="text-[0.6rem] ml-auto mt-1">R$</span><span class="text-xl">0.0</span>
                                </h3>
                            </li>
                            <hr class="border-gray-300" />
                            <li class="flex flex-wrap gap-2 text-xl font-bold">
                                Total<span class="text-[0.6rem] ml-auto mt-1">R$</span><span id='totalcarrinho'
                                    class="text-xl">
                                    {{ $total = Cart::total(2, ',', '.') }}
                        ...
                        <div class="mt-8 flex flex-col gap-2 space-y-2">
                            <a href="/">
                                <button type="button"
