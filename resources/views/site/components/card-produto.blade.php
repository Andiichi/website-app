    ...
    <div class="relative m-2 outline outline-offset-2 outline-1 rounded-md  h-auto w-auto">
        <a href="{{ route('site.details', $produto_slug) }}"
            ...
            <button type="button" aria-label="View item"
                class="hidden absolute top-28 left-22 items-center justify-center p-3 rounded-full  transition-all duration-500 transform opacity-0 group-hover:flex group-hover:opacity-100 hover:scale-125 bg-gray-300  hover:text-white  hover:bg-indigo-500">
        ...
        <div class="flex flex-col justify-between p-4 leading-normal z-0 w-full">
            <h5
                class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white transition-opacity duration-300 group-hover:opacity-50 line-clamp-2">
                {{ $produto_nome }}
            </h5>
            <p
                class="mb-3 font-normal text-gray-700 dark:text-gray-400 transition-opacity duration-500 group-hover:opacity-50">
                {{ $produto_descricao }}
            </p>
        ...
        <span
            ...
            <svg class="w-2.5 h-2.5 me-1.5" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#233876 ">
