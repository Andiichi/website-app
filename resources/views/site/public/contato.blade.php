...
@section('conteudo')
    ...
    <div class="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl bg-gray-100 font-[sans-serif]">
        <div>
            <h1 class="text-gray-800 text-3xl font-extrabold">Entre em contato!</h1>
        ...
        <form class="ml-auto space-y-4">
            <input type='text' placeholder='Name'
                class="w-full rounded-md py-3 px-4 bg-gray-200 text-gray-800 text-sm outline-gray-500  focus:bg-transparent" />
            <input type='email' placeholder='Email'
                class="w-full rounded-md py-3 px-4 bg-gray-200 text-gray-800 text-sm outline-gray-500 focus:bg-transparent" />
            <input type='text' placeholder='Subject'
                class="w-full rounded-md py-3 px-4 bg-gray-200 text-gray-800 text-sm outline-gray-500 focus:bg-transparent" />
            <textarea placeholder='Message' rows="6"
                class="w-full rounded-md px-4 bg-gray-200 text-gray-800 text-sm pt-3 outline-gray-500 focus:bg-transparent"></textarea>
            <button type='button'
                class="text-white bg-gray-600 hover:bg-gray-500 tracking-wide rounded-md text-sm px-4 py-3 w-full !mt-6">Send</button>
        </form>
    </div>
